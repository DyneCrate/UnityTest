...
public class BoardController : MonoBehaviour
{
    ...
    public PlayerTurnHandler GameModel { get; private set; }

    [SerializeField] private TextMeshProUGUI userTxt = null;
    [SerializeField] private TextMeshProUGUI userInfoMoney = null;
    ...
    private void Awake()
    {
        ...
        Instance = this;
        GameModel = GetComponent<PlayerTurnHandler>();
        GameModel.Init();
    }
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            // Bit shift the index of the layer (3) to get a bit mask, this layer only includes the pieces.
            int layer = 3;
    ...
    private void SetPlayAction(int targetTileIdx, Piece attackedPiece = null)
    {
        ...
        if (attackedPiece)
        {
            ...
            if (false)//(attackedPiece.pieceData.isKing)
            {
                SetUserEndGameText();
                GameModel.GameIsOver = true;
            }
    ...
    public void SetNextPlayerTurn()
    {
        ...
        if (!GameModel.GameIsOver)
        {
            GameModel.MoveCount++;
            turnDisabled = false;
            GameModel.AddMoneyToCurrentPlayer();
    ...
    public void SetUserTurnText()
    {
        ...
        userInfoMoney.text = GameModel.GetCurrentPlayerMoney() + "$$";
    }
    ...
    private void UnpickCurrentPieceMaterial()
    {
        ...
        GameObject child = GameModel.CurrentClickedPiece.gameObject;
